...
<div>
    ...
    @else
        <div class="grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-1 gap-3">
                ...
                <div class="flex flex-wrap items-center justify-center gap-4">
                    <div class="bg-white rounded-2xl pb-4 overflow-hidden border border-gray-500/30">
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <p @class([
                                'text-green' => $carro->status == 'Livre',
                                'text-red' => $carro->status == 'Reservado',
                                'text-sm',
                            ])>{{ $carro->status }}</p>
                            <div class="d-flex flex-row ">
                                @if (Auth::user() == $carro->user)
                                    ...
                                    <x-danger-button wire:click="destroy({{ $carro->id }})"
