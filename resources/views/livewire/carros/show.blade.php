            ...
            <div class="flex flex-wrap items-center justify-center gap-4">
                <div class="bg-white rounded-2xl pb-4 overflow-hidden border border-gray-500/30">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <button
                            class="border text-sm text-gray-500 border-gray-500/30 w-28 h-8 rounded-full mt-5 flex items-center justify-center gap-1">
                            <svg class="mt-0.5" width="13" height="13" viewBox="0 0 13 13" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#6B7280"/>
                                <path d="M3.844 5.552h.005m2.268 0h.005m2.272 0H8.4" stroke="#6B7280" stroke-width="1.5"
